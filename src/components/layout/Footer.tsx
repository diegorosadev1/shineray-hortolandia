    ...
    <footer className="bg-[#050505] pt-20 pb-10 relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-screen-2xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-2">
              <div className="bg-[#ff0000] px-3 py-1 transform -skew-x-12">
                <span className="text-white font-black italic uppercase tracking-tighter transform skew-x-12 block">
                  SHINERAY
                </span>
              </div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Sua concessionária Shineray em Hortolândia. As melhores motos, os
              melhores preços e o atendimento que você merece.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-white hover:bg-[#ff0000] transition-all group"
              >
                <Instagram
                  size={18}
          ...
          {/* Menu Column */}
          <div className="flex flex-col gap-6">
            <h4 className="text-white font-black italic uppercase text-xs tracking-[0.2em] border-l-2 border-[#ff0000] pl-3">
              Menu
            </h4>
              ...
              {[
                ...
                <li key={item}>
                  <a
                    ...
                    className="text-gray-500 hover:text-white text-sm flex items-center gap-2 group transition-colors"
                  >
                    <ChevronRight
                      size={14}
                      className="text-[#ff0000] opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all"
                    />
                    {item}
                  </a>
                </li>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-500 text-sm">
                  contato@shinerayhortolandia.com.br
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-zinc-900/80 p-6 rounded-[32px] border border-white/10 relative group overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="text-white font-black italic uppercase text-sm leading-tight">
                    Especialista Online
                  </p>
                  <p className="text-[#25D366] text-[10px] font-black uppercase tracking-widest">
                    Disponível agora
                  </p>
                </div>
              </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            <p className="text-gray-600 text-[10px] font-bold uppercase tracking-widest">
              Design & Dev by{" "}
              <a
                href="https://www.diegorosadev.com.br/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[#ff0000] transition-colors duration-300 relative group"
              >
                diegorosadev
                <span className="absolute -bottom-0.5 left-0 w-0 h-[1px] bg-[#ff0000] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </p>
            <button
              onClick={scrollToTop}
