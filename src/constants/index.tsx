...
export const MOCK_MOTOS: Motorcycle[] = [
  { id: '1', name: 'SHINERAY SHI 175 EFI', price: 15990, year: '2024/2024', mileage: '0', fuel: 'Gasolina', transmission: 'Manual', image: 'https://images.unsplash.com/photo-1558981403-c5f91cbba527?q=80&w=800&auto=format&fit=crop', brand: 'Shineray', model: 'SHI 175', version: 'EFI', color: 'Vermelho', category: 'Trail' },
  ...
  { id: '6', name: 'SHINERAY STORM 200', price: 18990, year: '2024/2024', mileage: '0', fuel: 'Gasolina', transmission: 'Manual', image: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?q=80&w=800&auto=format&fit=crop', brand: 'Shineray', model: 'Storm 200', version: 'Standard', color: 'Preto Fosco', category: 'Naked' },
  { id: '7', name: 'SHINERAY EXPLORER 150', price: 12990, year: '2024/2024', mileage: '0', fuel: 'Gasolina', transmission: 'Manual', image: 'https://images.unsplash.com/photo-1449495169669-7b118f960233?q=80&w=800&auto=format&fit=crop', brand: 'Shineray', model: 'Explorer 150', version: 'Standard', color: 'Verde', category: 'Trail' },
  { id: '8', name: 'SHINERAY BOLT 250', price: 16490, year: '2023/2024', mileage: '500', fuel: 'Gasolina', transmission: 'Manual', image: 'https://images.unsplash.com/photo-1558981403-c5f91cbba527?q=80&w=800&auto=format&fit=crop', brand: 'Shineray', model: 'Bolt 250', version: 'Custom', color: 'Preto', category: 'Custom' },
  ...
  { id: '14', name: 'SHINERAY SPEED 150', price: 11490, year: '2024/2024', mileage: '0', fuel: 'Gasolina', transmission: 'Manual', image: 'https://images.unsplash.com/photo-1449495169669-7b118f960233?q=80&w=800&auto=format&fit=crop', brand: 'Shineray', model: 'Speed 150', version: 'Standard', color: 'Branco', category: 'Street' },
  { id: '15', name: 'SHINERAY XY 50', price: 6990, year: '2024/2024', mileage: '0', fuel: 'Gasolina', transmission: 'Semiautomático', image: 'https://images.unsplash.com/photo-1558981403-c5f91cbba527?q=80&w=800&auto=format&fit=crop', brand: 'Shineray', model: 'XY 50', version: 'Standard', color: 'Preto', category: 'CUB' },
